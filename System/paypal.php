...
if (isset($_POST["enviar"])) {
    ...
    try {
        ...
        // Direcione o usuário para a URL de aprovação do PayPal
        header('Location: ' . $payment->getApprovalLink());

        // Salve as informações do pagamento no banco de dados
...
<div class="page">
        ...
        <p>Digite os dados de acesso para cadastro nos campos abaixo.</p>
